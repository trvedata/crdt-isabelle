...
\begin{abstract}
Data replication is used in distributed systems to maintain up-to-date copies of some data across multiple computers in a network.
...
%
\item We demonstrate our framework is highly reusable: we developed proofs of the Observed-Removed Set and a Increment-Decrement Counter CRDTs in a few hours and with little CRDT-specific code. %TODO quantify "little" here.
\end{itemize}
