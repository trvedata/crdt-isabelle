...
Here, we will use the $\isa{hb}$ inductive relation, defined earlier in this section, as that implementation.
We have already noted that it does indeed form a preorder.
...
We end this section by describing an analogue of the convergence theorem in Section
