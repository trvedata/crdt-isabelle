...
\renewenvironment{isabelle}{%
  ...
  \begin{minipage}{\textwidth-2\parindent}% use minipage to prevent page breaks
  \begin{isabellebody}%
}{%
  \end{isabellebody}%
  \end{minipage}%
