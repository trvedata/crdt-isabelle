...
The logic's type system resembles that of mainstream functional programming languages, such as Standard ML, OCaml, or Haskell.
\emph{Function types} are written $\tau_1 \Rightarrow \tau_2$ are inhabited by \emph{total} functions, mapping elements of $\tau_1$ to elements of $\tau_2$.
