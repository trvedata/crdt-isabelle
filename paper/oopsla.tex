...
We discuss three here: \emph{strict consistency}, \emph{eventual consistency}, and a variant of the latter called \emph{strong eventual consistency}.

\emph{Strict consistency} is a popular consistency model for transactional databases.
...
These strategies are often \emph{ad hoc} and error prone, motivating strong eventual consistency.

\emph{Strong eventual consistency} is a consistency model 
