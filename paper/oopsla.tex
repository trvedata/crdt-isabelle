...
This transformer is used to define a CRDT-specific locale, a specialisation of the $(\isa{constrained}){\isacharunderscore}\isa{network}{\isacharunderscore}\isa{with}{\isacharunderscore}\isa{ops}$ locale, which may also provide restrictions on valid network behaviours in order to ensure convergence.
