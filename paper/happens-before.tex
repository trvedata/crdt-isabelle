...
\node [leftlabel]  at (0,2.0) {$\mathit{op}_1$};
\node [rightlabel] at (1,1.5) {$\mathit{op}_1$};
\node [leftlabel]  at (0,1.0) {$\mathit{op}_2$};
\node [rightlabel] at (1,0.5) {$\mathit{op}_2$};
\draw (i1name) -- (0,0) node [left=5pt,at end] {\footnotesize time};
\draw (j1name) -- (1,0);
\draw (op1send) -- (op1recv);
\draw (op2send) -- (op2recv);
\node [caption] at (0.5,0) {
    $\mathit{op}_1 \prec \mathit{op}_2$
    because node $i$ broadcast $\mathit{op}_1$ before $\mathit{op}_2$
};
...
\node [leftlabel]  at (3,2.0) {$\mathit{op}_1$};
\node [rightlabel] at (5,1.5) {$\mathit{op}_1$};
\node [leftlabel]  at (4,1.0) {$\mathit{op}_2$};
\node [rightlabel] at (5,0.5) {$\mathit{op}_2$};
\draw (i2name) -- (3,0);
\draw (j2name) -- (4,0);
\draw (k2name) -- (5,0);
...
\node [caption] at (4.0,0) {
    $\mathit{op}_1 \prec \mathit{op}_2$
    because node $j$ delivered $\mathit{op}_1$ before broadcasting $\mathit{op}_2$
};
...
\node [leftlabel]  at  (7,2.0) {$\mathit{op}_1$};
\node [rightlabel] at (10,1.7) {$\mathit{op}_1$};
\node [leftlabel]  at  (8,1.4) {$\mathit{op}_2$};
\node [rightlabel] at (10,1.1) {$\mathit{op}_2$};
\node [leftlabel]  at  (9,0.8) {$\mathit{op}_3$};
\node [rightlabel] at (10,0.5) {$\mathit{op}_3$};
\draw (i3name) -- (7,0);
\draw (j3name) -- (8,0);
\draw (k3name) -- (9,0);
\draw (m3name) -- (10,0);
...
\node [caption] at (8.5,0) {
    $\mathit{op}_1 \prec \mathit{op}_3$ because
    $\mathit{op}_1 \prec \mathit{op}_2$ and
    $\mathit{op}_2 \prec \mathit{op}_3$
};
