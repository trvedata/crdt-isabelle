...
This can be demonstrated by building a trivial model of $\isa{network}{\isacharunderscore}\isa{with}{\isacharunderscore}\isa{constrained}{\isacharunderscore}\isa{ops}$, and all superlocales, within Isabelle and showing that it satisfies all of the locale's axioms.
We elide the construction of these models.
