...
can communicate only by sending and receiving messages over a network. We assume that messages sent via the network may be delayed,
...
As discussed in the introduction, we aim to support scenarios in which subsets of
