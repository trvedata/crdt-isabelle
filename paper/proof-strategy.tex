...
By lines of code, approximately half of our proof is used to construct a general-purpose model of consistency in distributed systems, described in Section~\ref{sect.abstract.convergence}, and an axiomatic model of a computer network, described in Section~\ref{sect.network}.
These modules are independent of any particular replication algorithm.
The remainder contains our formalisation of three example CRDTs and their proofs of correctness, described in Sections~\ref{sect.rga} and~\ref{sect.simple.crdts}.
%TODO Review whether the split between framework and CRDTs is still 50/50
