...
\begin{scope}[text width=5cm,font=\footnotesize]
    ...
    \node at (0, 0.2) {Example CRDTs\\(Sections \ref{sect.simple.crdts} and \ref{sect.rga})};
\end{scope}
...
\begin{scope}[>=open triangle 60]
    ...
    \draw (node cs:name=netops2,angle=170) to [out=90,in=270] (node cs:name=netops, angle=340);
    ...
    \draw (node cs:name=rga,    angle=50)  to [out=90,in=270] (node cs:name=netops2,angle=240);
